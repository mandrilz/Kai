...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#1D1D1D]">
      <div className="max-w-md w-full px-6 py-8 bg-[#282828] rounded-lg shadow-lg">
        <div className="text-center mb-6" style={{ lineHeight: '1.15', marginBottom: '16px' }}>
          <div style={{
            fontSize: '28px',
            fontWeight: 700,
            letterSpacing: '0.6px',
          ...
          <div style={{
            ...
            первый искусственный интеллект<br />
            в мире насосного оборудования
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-4 py-2 border border-[#3A3A3A] rounded-lg bg-[#282828] text-[#EDEDED] placeholder:text-[#8A8A8A] focus:ring-2 focus:ring-[#E49E00] focus:border-transparent"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#E49E00] text-white py-2 px-4 rounded-lg hover:bg-[#C88A00] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
        ...
        {message && (
          <div className={`mt-4 p-3 rounded-lg ${
            message.includes('ошибка') 
              ? 'bg-[#282828] text-[#C94A3A]' 
              : 'bg-[#282828] text-[#4CAF50]'
          }`}>
            {message}
          </div>
        )}
