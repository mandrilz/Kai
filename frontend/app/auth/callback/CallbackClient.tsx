      ...
      <div className="max-w-md w-full px-6 py-8 bg-[#282828] rounded-lg shadow-lg text-center">
        {status === 'loading' && (
          <>
            ...
            <p className="text-[#EDEDED]">Проверка токена...</p>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-[#4CAF50]">{message}</p>
          </>
        )}
        
        {status === 'error' && (
          <>
            <div className="text-[#C94A3A] text-4xl mb-4">✗</div>
            <p className="text-[#C94A3A] mb-4">{message}</p>
            <button
